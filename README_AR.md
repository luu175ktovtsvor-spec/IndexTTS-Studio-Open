...
تُحفظ الملفات الصوتية المؤقتة للواجهة الأصلية داخل المشروع فقط في `outputs/gradio-cache`. تُمسح قبل التشغيل وبعد الخروج الطبيعي، ويحذف Gradio دوريًا الملفات الأقدم من 15 دقيقة أثناء التشغيل. لا يتم تنظيف مجلدات النظام المؤقتة المشتركة.
